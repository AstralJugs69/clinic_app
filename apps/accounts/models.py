...
class ActionLog(models.Model):
    ...
    ACTION_CHOICES = [
        ...
        ("doctor_accepted", "Doctor Accepted Patient"),
        ("transferred_to_room", "Transferred To Room"),
        ("room_accepted", "Room Accepted Patient"),
        ("room_transferred", "Room Transferred Patient"),
    ...
    def action_icon(self):
        ...
        icons = {
            ...
            "checked_in": "✅",
            "doctor_accepted": "🩺",
            "transferred_to_room": "➡️",
            "room_accepted": "🏥",
            "room_transferred": "🔁",
            "completed_appointment": "✔️",
            "login": "🔐",
            "logout": "🚪",
        }
    ...
    def action_color(self):
        ...
        colors = {
            ...
            "checked_in": "emerald",
            "doctor_accepted": "cyan",
            "transferred_to_room": "amber",
            "room_accepted": "teal",
            "room_transferred": "orange",
            "completed_appointment": "green",
            "login": "purple",
            "logout": "gray",
        }
